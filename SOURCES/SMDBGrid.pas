          ...
          begin
            ...
            begin
              ...
              try
                ...
                {AsBoolean works much faster than VarAsType}
                if (((DrawColumn.Field is TStringField) or (DrawColumn.Field is TBooleanField)) and DrawColumn.Field.AsBoolean) or
                   VarAsType(DrawColumn.Field.Value, varBoolean) then
                  CheckState := cbChecked
              except
              end;
              Canvas.FillRect(ARect);
...
//20051027     (GridStyle.Style <> gsNormal) and
  ...
  begin
    ...
    try
      ...
      {AsBoolean works much faster than VarAsType}
      if (((Column.Field is TStringField) or (Column.Field is TBooleanField)) and Column.Field.AsBoolean) or
         VarAsType(Column.Field.Value, varBoolean) then
